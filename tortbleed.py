...
# Source : https://gist.github.com/sh1n0b1/10100394

# Modified by Derek Callaway (decal@ethernet.org) to add STARTTLS protocols
# Source : https://github.com/decal/ssltest-stls/blob/master/ssltest-stls.py

# Modified by Samiux from the code of Derek Callaway on April 11, 2014

# Further Modified by Mike Baker from the code of Samiux to support scanning
# raw tor .onion addresses on April 24th, 2014
...
options = OptionParser(usage='%prog server[.onion] [options]', description='Test for SSL heartbeat vulnerability (CVE-2014-0160)')
...
def main():
    ...
    if 'onion' in args[0]:
      import socks
      from torwrapper import TorWrapper

      print 'Starting Tor Daemon & Connecting to Tor Network...'

      tor = TorWrapper()
      tor.on(verbose=True)

    else:
      print 'Connecting to non-onion address...'
